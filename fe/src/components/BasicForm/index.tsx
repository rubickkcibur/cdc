  ...
  return (
    <Form onValuesChange={onValueChange} form={form}>
      <Row gutter={halfGutter}>
        <Col {...halfItemGrid}>
          <FormItem label={"姓名"} name={"name"} style={itemStyle}>
            <Input placeholder={"请输入姓名"} />
          </FormItem>
        </Col>
        <Col {...halfItemGrid}>
          <FormItem label={"性别"} name={"gender"} initialValue={"male"} style={itemStyle}>
            <Select>
      ...
      <Row gutter={halfGutter} >
        <Col {...halfItemGrid}>
          <FormItem label={"电话"} name={"phone"} style={itemStyle}>
            <Input placeholder={"请输入电话"} />
          </FormItem>
        </Col>
        <Col {...halfItemGrid}>
          <FormItem label={"年龄"} name={"age"} style={itemStyle}>
      ...
      <Row gutter={halfGutter}>
        <Col {...fullItemGrid}>
          <FormItem label={"住址"} name={"addr1"} style={itemStyle}>
      ...
      <Row gutter={halfGutter}>
        <Col {...fullItemGrid}>
          <FormItem label={""} colon={false} name={"addr2"} style={itemStyle}>
